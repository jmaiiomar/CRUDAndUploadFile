...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ymkpS22znP', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bjhxUfvKlL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    /**
     * Gets the private '.service_locator.mJ4rTOU' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_MJ4rTOUService()
    {
        return $this->privates['.service_locator.mJ4rTOU'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5r08W8nyo8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.mJ4rTOU'] ?? $this->get_ServiceLocator_MJ4rTOUService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd90cd = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializeraf584 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesa9726 = [
        
    ];

    public function getConnection()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getConnection', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getMetadataFactory', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getExpressionBuilder', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'beginTransaction', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->beginTransaction();
    }

    public function getCache()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getCache', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getCache();
    }

    public function transactional($func)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'transactional', array('func' => $func), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->transactional($func);
    }

    public function commit()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'commit', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->commit();
    }

    public function rollback()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'rollback', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getClassMetadata', array('className' => $className), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'createQuery', array('dql' => $dql), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'createNamedQuery', array('name' => $name), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'createQueryBuilder', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'flush', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'clear', array('entityName' => $entityName), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->clear($entityName);
    }

    public function close()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'close', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->close();
    }

    public function persist($entity)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'persist', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'remove', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'refresh', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'detach', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'merge', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getRepository', array('entityName' => $entityName), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'contains', array('entity' => $entity), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getEventManager', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getConfiguration', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'isOpen', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getUnitOfWork', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getProxyFactory', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'initializeObject', array('obj' => $obj), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'getFilters', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'isFiltersStateClean', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'hasFilters', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return $this->valueHolderd90cd->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializeraf584 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd90cd) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd90cd = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd90cd->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, '__get', ['name' => $name], $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        if (isset(self::$publicPropertiesa9726[$name])) {
            return $this->valueHolderd90cd->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd90cd;
    ...
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, '__set', array('name' => $name, 'value' => $value), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;
    ...
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, '__isset', array('name' => $name), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;
    ...
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, '__unset', array('name' => $name), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;
    ...
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, '__clone', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        $this->valueHolderd90cd = clone $this->valueHolderd90cd;
    }

    public function __sleep()
    {
        $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, '__sleep', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;

        return array('valueHolderd90cd');
    }
    ...
    {
        $this->initializeraf584 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializeraf584;
    }

    public function initializeProxy() : bool
    {
        return $this->initializeraf584 && ($this->initializeraf584->__invoke($valueHolderd90cd, $this, 'initializeProxy', array(), $this->initializeraf584) || 1) && $this->valueHolderd90cd = $valueHolderd90cd;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd90cd;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd90cd;
    }
}
